  ...
  return (
    <>
      <Card className="rounded-2xl border bg-white text-black border-black/10 dark:bg-neutral-900 dark:text-neutral-100 dark:border-neutral-800">
        ...
        {/* فرم افزودن */}
        <div className="rounded-2xl p-3 mb-4 border border-black/10 bg-white text-black dark:bg-neutral-900 dark:text-neutral-100 dark:border-neutral-800">
          <div className="grid md:grid-cols-[1fr_auto] items-end gap-2">
            ...
            <button
              ...
              className="h-10 w-10 grid place-items-center rounded-xl
                         bg-neutral-900 text-white disabled:opacity-50 hover:opacity-90 transition
                          ...
                          {editId === u.id ? (
                            ...
                            <div className="inline-flex items-center justify-center gap-2">
                              ...
                              <Btn
                                ...
                                className="!h-10 !w-10 !p-0 !rounded-xl !bg-transparent !ring-0 !border-0 !shadow-none
        ...
        {accessOpen && (
          <div className="fixed inset-0 z-50 grid place-items-center bg-black/40 backdrop-blur-sm">
            <div
              className="w-[min(96vw,820px)] max-w-[820px] max-h-[90vh] overflow-auto
                         rounded-3xl shadow-2xl ring-1 ring-black/10 dark:ring-neutral-800
                         p-6 bg-white text-black dark:bg-neutral-900 dark:text-neutral-100"
              dir="rtl"
            >
