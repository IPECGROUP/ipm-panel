      ...
      <div className="p-3 md:p-4">
        ...
        {showForm && <form onSubmit={submit} className={`mb-5 space-y-4 rounded-2xl border border-black/10 bg-neutral-50/70 p-4 dark:border-white/10 dark:bg-white/[.03] md:p-5 ${requestType === "normal" ? "" : "hidden"}`}>
          ...
          <div className="grid grid-cols-1 items-start gap-3 md:grid-cols-2 xl:grid-cols-[minmax(220px,1.15fr)_minmax(200px,0.85fr)_minmax(145px,0.55fr)_minmax(170px,0.7fr)]">
            ...
            <div className="flex min-h-11 items-end pb-2 text-sm text-neutral-700 dark:text-neutral-200">ریال: <span className="mr-1 font-medium tabular-nums" dir="ltr">{toFa(money(rialAmount) || "0")} ریال</span></div>
          </div>
