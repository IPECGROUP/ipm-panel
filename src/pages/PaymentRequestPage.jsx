          ...
          <main className="min-h-0 overflow-y-auto p-4 md:p-5">
            <div className="space-y-4">
              <PreviewSection title="جزئیات درخواست پرداخت" flush>
                ...
                <PreviewRow editing={canEditRequest} colon label="شرح درخواست" valueClassName={!canEditRequest ? "text-xs font-normal leading-5" : ""} value={canEditRequest ? <textarea className={`${inputClass} h-[68px] min-h-[68px] resize-y py-1.5 leading-6`} value={editForm.description} onChange={(event) => setEditField("description", event.target.value)} /> : (item.description || "—")} />
