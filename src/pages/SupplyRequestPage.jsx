                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <button
                      ...
                      className="inline-flex h-10 w-[64px] items-center justify-center rounded-xl border border-black/10 bg-white text-sm transition hover:bg-black/[0.03] dark:border-white/15 dark:bg-white/5 dark:hover:bg-white/10"
                      title="اسناد مرتبط"
