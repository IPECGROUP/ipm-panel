...
const groups = [
  ...
  { label: "مدیریت مالی", pages: ["درخواست پرداخت", "تنخواه گردان", "تخصیص نقدینگی", "پیش‌بینی جریان نقدی"] },
  { label: "مدیریت تأمین", pages: ["درخواست تأمین"] },
  { label: "مدیریت اجرا", pages: [] },
  { label: "مدیریت دانش", pages: ["درس‌آموخته‌ها", "کتابخانه‌ها", "منابع آموزشی"] },
  { label: "تنظیمات", pages: [] },
];

const pageColumns = {
  "مدیریت اسناد": ["همه", "نمایش منو", "افزودن", "بارگذاری سند پیوست", "نمایش سند پیوست", "ارسال", "ویرایش", "حذف", "اسناد محرمانه", "داشبورد مدیریت اسناد"],
  "قراردادها": ["همه", "نمایش منو", "افزودن", "پیش‌نمایش", "ویرایش", "حذف", "عمومی", "تقویم قرارداد", "دامنه کار", "مالی و تضامین", "تأمین اجتماعی", "الحاقیه", "داشبورد مدیریت قراردادها"],
  "روزنگار پروژه": ["همه", "نمایش منو", "افزودن"],
  "ساختار شکست هزینه‌ها": ["همه", "نمایش منو"],
  "تعهدات و مصارف مالی": ["همه", "نمایش منو"],
  "کاربرگ مالی": ["همه", "نمایش منو", "صورت وضعیت‌ها", "دریافتی‌ها", "داشبورد مدیریت پروژه"],
  "درخواست پرداخت": ["همه", "نمایش منو", "افزودن"],
  "تنخواه گردان": ["همه", "نمایش منو", "افزودن"],
  "تخصیص نقدینگی": ["همه", "نمایش منو", "افزودن"],
  "پیش‌بینی جریان نقدی": ["همه", "نمایش منو", "پیش‌بینی هزینه‌ها", "پیش‌بینی درآمدها", "نمودار جریان نقدی", "داشبورد مدیریت مالی"],
  "درخواست تأمین": ["همه", "نمایش منو", "افزودن", "داشبورد مدیریت تأمین"],
...
const pageIndex = { "مدیریت اسناد": 1, "قراردادها": 2, "روزنگار پروژه": 4, "ساختار شکست هزینه‌ها": 5, "تعهدات و مصارف مالی": 6, "کاربرگ مالی": 7, "تنخواه گردان": 8, "درخواست پرداخت": 9, "تخصیص نقدینگی": 10, "پیش‌بینی جریان نقدی": 11, "درخواست تأمین": 13, "درس‌آموخته‌ها": 14, "کتابخانه‌ها": 15, "منابع آموزشی": 16 };
