...
function RightNav() {
  ...
  const isAliSuperAdmin = String(user?.username || "").trim().toLowerCase() === "ali" &&
      ...
      items: [
        {
          ...
          items: [
            ...
            ...(isAliSuperAdmin ? [{ to: "/admin/security-audit", label: "گزارش امنیتی", hint: "لاگ ورود و تغییرات مهم", icon: <NavIcon src="/images/icons/gozareshha.svg" /> }] : []),
          ],
        },
      ],
    },
