...
export default function Shell() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="px-2 sm:px-3 md:px-6 py-2.5 md:py-3 lg:pr-[var(--right-nav-space)] lg:pl-8 transition-[padding] duration-300 ease-in-out">
      ...
      <main className="relative min-h-[calc(100dvh-64px)] md:min-h-[calc(100dvh-80px)]">
        <div
          dir="ltr"
          className="px-2 sm:px-3 md:px-6 pt-3 md:pt-6 pb-[calc(7rem+env(safe-area-inset-bottom,0px))] lg:pb-6 lg:pr-[var(--right-nav-space)] lg:pl-8 transition-[padding] duration-300 ease-in-out"
        >
